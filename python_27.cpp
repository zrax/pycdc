...
int python_27_map(int id)
{
    ...
    case 94: return Pyc::LIST_APPEND_A;
    ...
    case 145: return Pyc::EXTENDED_ARG_A;
...
int python_27_unmap(int id)
{
    ...
    case Pyc::EXTENDED_ARG_A: return 145;
    ...
    case Pyc::LIST_APPEND_A: return 94;
